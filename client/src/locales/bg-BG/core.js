...
export default {
  ...
  translation: {
    common: {
      ...
      aboutTrelloSaggio_title: 'За TRELLO SAGGIO',
      ...
      discoverTrelloSaggioPro: '✨ Повече функции за вашите дъски: Открийте TRELLO SAGGIO Pro',
      discoverTrelloSaggioPro_title: 'Открийте TRELLO SAGGIO Pro',
      ...
      trelloSaggioUsesAppriseToSendNotificationsToOver100PopularServices:
        'TRELLO SAGGIO използва <1><0>Apprise</0></1> за изпращане на уведомления до над 100 популярни услуги.',
      port: 'Порт',
