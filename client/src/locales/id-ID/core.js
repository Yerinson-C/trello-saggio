...
export default {
  ...
  translation: {
    common: {
      ...
      aboutTrelloSaggio_title: 'Tentang TRELLO SAGGIO',
      ...
      discoverTrelloSaggioPro: '✨ Lebih banyak fitur untuk papan Anda: Temukan TRELLO SAGGIO Pro',
      discoverTrelloSaggioPro_title: 'Temukan TRELLO SAGGIO Pro',
      ...
      trelloSaggioUsesAppriseToSendNotificationsToOver100PopularServices:
        'TRELLO SAGGIO menggunakan <1><0>Apprise</0></1> untuk mengirim notifikasi ke lebih dari 100 layanan populer.',
      port: 'Port',
