...
export default {
  ...
  translation: {
    common: {
      ...
      aboutTrelloSaggio_title: 'Σχετικά με το TRELLO SAGGIO',
      ...
      discoverTrelloSaggioPro:
        '✨ Περισσότερες λειτουργίες για τους πίνακές σας: Ανακαλύψτε το TRELLO SAGGIO Pro',
      discoverTrelloSaggioPro_title: 'Ανακαλύψτε το TRELLO SAGGIO Pro',
      ...
      trelloSaggioUsesAppriseToSendNotificationsToOver100PopularServices:
        'Το TRELLO SAGGIO χρησιμοποιεί το <1><0>Apprise</0></1> για να στέλνει ειδοποιήσεις σε πάνω από 100 δημοφιλείς υπηρεσίες.',
      port: 'Θύρα',
