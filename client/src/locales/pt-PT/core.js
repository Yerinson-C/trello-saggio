...
export default {
  ...
  translation: {
    common: {
      ...
      aboutTrelloSaggio_title: 'Sobre o TRELLO SAGGIO',
      ...
      discoverTrelloSaggioPro: '✨ Mais funcionalidades para os seus quadros: Descubra o TRELLO SAGGIO Pro',
      discoverTrelloSaggioPro_title: 'Descubra o TRELLO SAGGIO Pro',
      ...
      trelloSaggioUsesAppriseToSendNotificationsToOver100PopularServices:
        'O TRELLO SAGGIO usa o <1><0>Apprise</0></1> para enviar notificações para mais de 100 serviços populares.',
      port: 'Porta',
